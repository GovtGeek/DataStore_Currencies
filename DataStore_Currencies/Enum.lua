...
enum.CurrencyIDs = {
	...
	-- Midnight 12.0
	VoidlightMarl = 3316,
	TwilightsBladeInsignia = 3319,
	AnglerPearls = 3373,
	ShardofDundun = 3376,
	UnalloyedAbundance = 3377,
	BrimmingArcana = 3379,
	RemnantofAnguish = 3392,
	IllusionaryCoin = 3393,
	UncontaminatedVoidSample = 3400,
	FieldAccolade = 3405,

	ArtisanAlchemistsMoxie = 3256,
	ArtisanHerbalistsMoxie = 3260,
	ArtisanMinersMoxie = 3264,
	ArtisanEnchantersMoxie = 3258,
	ArtisanTailorsMoxie = 3266,
	ArtisanBlacksmithsMoxie = 3257,
	ArtisanSkinnersMoxie = 3265,
	ArtisanLeatherworkersMoxie = 3263,
	ArtisanEngineersMoxie = 3259,
	ArtisanJewelcraftersMoxie = 3262,
	ArtisanScribesMoxie = 3261,

	-- Midnight 12.0 / Season 1
	NebulousVoidcore = 3418,
	DawnlightManaflux = 3378,
	MythDawncrest = 3347,
	ChampionDawncrest = 3343,
	HeroDawncrest = 3345,
	UntaintedManaCrystals = 3356,
	RadiantSparkDust = 3212,
